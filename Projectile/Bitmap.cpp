...
Bitmap::Bitmap(float width, float height, Vector textureTopLeft, Vector textureBottomRight) : Model(
...
Bitmap::Bitmap(float width, float height) : Bitmap(width, height, Vector(0.0f, 0.0f), Vector(1.0f, 1.0f)) {
